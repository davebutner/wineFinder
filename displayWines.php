...
echo 'Winery is: '; echo $selected_winery; echo  ' \n ';
echo 'Varietal is: '; echo $selected_varietal; echo  ' \n ';
?>
                          ...
                          <tr>
                              <div class="card flex-md-row mb-4 shadow-sm h-md-250" style="width: 100rem;">
                                  <div class="card-body d-flex flex-column align-items-start">
                                      ...
                                      <a class="btn btn-outline-primary btn-sm" role="button" href=<?php echo $r['url'] ?>>Go to Wine</a>
                                  </div>
