...
INNER JOIN wines on winery.idwinery=wines.idwinery";
            ...
            if ($selected_winery != "ALL")
            {
                $sqlStmnt .= " WHERE winery.name = '$selected_winery'";
            }
            else
            {
                $sqlStmnt .= " WHERE winery.name LIKE '%%'";
            }

            //Add varietal to select
            if ($selected_varietal != "ALL")
            {
                $sqlStmnt .= " AND wines.name LIKE '%$selected_varietal%'";
            }
            else
            {
                $sqlStmnt .= " AND wines.name LIKE '%%'";
            }
          ...
          <div class="container">
              ...
              <div class="row">
                  ...
                  <table>
                      <?php while ($r = $q->fetch()): ?>
                          <tr>
                              <div class="card flex-md-row mb-4 shadow-sm h-md-250 bg-light mb-3" style="width: 80rem;">
                                  <div class="card-body d-flex flex-column align-items-start">
                                      <strong class="d-inline-block mb-2 text-primary"><?php echo $r['wineryname'] ?></strong></h5>
                                      ...
                                      <div class="mb-1 text-muted small">$<?php echo $r['winePrice'] ?> </div>
                                      ...
                                      <div class="btn-group" role="group" aria-label="Basic example">
                                         <a class="btn btn-primary btn-sm" role="button" href=<?php echo $r['url'] ?>>Go to Wine</a>
                                          <a class="btn btn-primary btn-sm" role="button" href=<?php echo $r['wineryURL'] ?>>Winery Website</a>
                                          <a class="btn btn-primary btn-sm" role="button" href='<?php echo $r['maplink'] ?>'  target="_blank">Map</a>
                                          <!-- Facebook -->
                                          ...
                                          <!-- Instagram -->
                                          <a class="btn btn-primary" style="background-color: #ac2bac;" href=<?php echo $r['instagram'] ?> role="button target="_blank"">

                                              <i class="fab fa-instagram fa-2x" style="color: #ac2bac;"></i>Instagram</a>
                                          <!-- Yelp -->
                                          <a class="btn btn-primary" style="background-color: red;" href="#!" role="button"
                                          ><i class="fab fa-twitter"></i>Yelp
                                          </a>
